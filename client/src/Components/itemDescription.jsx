    ...
    return (
      <div>
        ...
        <div style={{marginBottom: '18px'}}>
          <span className="price" style={{ fontWeight: 'bold', fontSize: '24px' }}>
            {' '}
$
            {this.state.price}
            {' '}
...
, listing #
                    ...
                    <button
                      ...
                      style={{
                        float: 'right', height: '40px', width: '70px', fontSize: '18px', backgroundColor: 'white'
                      }}
                    >
Cancel
                    ...
                    <button
                      onClick={this.closeAskQuestion}
                      style={{
                        float: 'right', height: '40px', width: '70px', fontSize: '18px', backgroundColor: 'black', color: 'white'
                      }}
                    >
Send
        ...
        {this.state.stateChange ? (
          ...
          Quantity
            <br />
            <select style={{ width: '45px', marginBottom: "18px" }}>
